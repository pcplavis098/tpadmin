...
<div class="box">
    <h4>
        <a target="_blank" href="http://baijunyao.com/article/71">thinkphp整合系列之phpqrcode生成二维码</a>
    </h4>
...
<div class="box">
    <h4>
        <a target="_blank" href="http://baijunyao.com/article/69">thinkphp整合系列之phpmailer批量发送邮件 </a>
    </h4>
...
<div class="box">
    <h4>
        <a target="_blank" href="http://baijunyao.com/article/75">thinkphp整合系列之支付宝MD5加密方式扫码支付  </a>
    </h4>
...
<div class="box">
    <h4>
        <a target="_blank" href="http://baijunyao.com/article/73">thinkphp整合系列之tcpdf生成pdf文件  </a>
    </h4>
...
<div class="box">
    <h4>
        <a target="_blank" href="http://baijunyao.com/article/72">thinkphp整合系列之融云即时通讯在线聊天  </a>
    </h4>
...
<div class="box">
    <h4>
        <a target="_blank" href="http://baijunyao.com/article/74">thinkphp整合系列之phpexcel生成生成excel文件  </a>
    </h4>
    <form action="<?php echo U('Home/Index/xls');?>" method="post">
        <table border="1">
            <tr>
                <td>
...
<div class="box">
    <h4>
        <a target="_blank" href="http://baijunyao.com/article/79">生成csv格式表格</a>
    </h4>
    <form action="<?php echo U('Home/Index/csv');?>" method="post">
        <table border="1">
            <tr>
                <td>
                    <input style="width: 25px;" type="text" name="data[1][1]" value="11">
...
<div class="box">
    <h4>
        <a target="_blank" href="http://baijunyao.com/article/82">thinkphp整合系列之phpexcel导入excel数据</a>
    </h4>
    <a href="<?php echo U('Home/Index/import_xls');?>" target="_blank">导入xls格式文件</a> &emsp;
    <a href="<?php echo U('Home/Index/import_csv');?>" target="_blank">导入csv格式文件</a>
</div>

<div class="box">
    <h4>
        <a target="_blank" href="http://baijunyao.com/article/77">thinkphp整合系列之微信扫码支付</a>
    </h4>
    <a href="<?php echo U('Home/Index/weixinpay_qrcode');?>" target="_blank">点击生成一个1分钱的微信支付二维码</a> <br />
</div>

<div class="box">
    <h4>
        <a target="_blank" href="http://baijunyao.com/article/78">thinkphp整合系列之微信公众号支付</a>
    </h4>
    <a href="<?php echo U('Home/Index/weixinpay_js');?>" target="_blank">在微信中点击生成一个1分钱的公众号支付订单</a>
</div>
...
<div class="box">
    ...
    <form id="geetest" action="<?php echo U('Home/Index/geetest_submit_check');?>" method="post">
...
<div class="box">
    <h4>
        <a target="_blank" href="http://baijunyao.com/article/80">thinkphp整合系列之webuploader异步预览上传</a>
    </h4>
    <form id="geetest" action="<?php echo U('Home/Index/webuploader');?>" method="post">
        <div id="upload-582052ea9d674" class="xb-uploader">
    <div class="queueList">
...
jQuery(function() {
    ...
    uploader = WebUploader.create({
        pick: {
            id: "#upload-582052ea9d674 .filePicker",
            label: '点击选择文件',
            multiple : true
        },
        dnd: "#upload-582052ea9d674 .queueList",
        paste: document.body,
        // accept: {
        //     title: 'Images',
    ...
    // 添加“添加文件”的按钮，
    uploader.addButton({
       id: "#upload-582052ea9d674 .filePicker2",
       label: '继续添加'
    });
    ...
    function updateStatus() {
        ...
        if ( state === 'ready' ) {
            ...
            if (fileCount==stats.successNum && stats.successNum!=0) {
                $('#upload-582052ea9d674 .webuploader-element-invisible').remove();
            }
        }
    ...
    function setState( val ) {
        ...
        switch ( state ) {
            ...
            case 'ready':
                ...
                $( "#upload-582052ea9d674 .filePicker2" ).removeClass( 'element-invisible');
            ...
            case 'uploading':
                $( "#upload-582052ea9d674 .filePicker2" ).addClass( 'element-invisible' );
                $progress.show();
                $upload.text( '暂停上传' );
                break;
    ...
    <a href="<?php echo U('Home/Index/webuploader');?>" target="_blank">点击在新页面中打开一个上传demo</a>
</div>
